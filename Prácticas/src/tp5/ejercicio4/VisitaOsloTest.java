...
public class VisitaOsloTest {
	...
	public static void main (String [] args) {
        ...
        List<String> listaRestringidos = new LinkedList<>();
        listaRestringidos.add("Akker Brigge");
        listaRestringidos.add("Palacio Real");
        listaRestringidos.add(null);
        
        VisitaOslo v = new VisitaOslo();
        System.out.println(v.paseoEnBici(lugares, "Museo Vikingo", 120, listaRestringidos));
	}
}
